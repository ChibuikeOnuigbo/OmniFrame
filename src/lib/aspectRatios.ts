...
export const RATIO_PRESETS: RatioPreset[] = [
  ...
  },
  {
    ...
    width: 1080,
    height: 1080,
    platforms: ['Instagram Feed', 'Square Video', 'Facebook Feed'],
  ...
  },
  {
    ...
    width: 1080,
    height: 1440,
    platforms: ['Tablet Display', 'Pinterest', 'iPad Video'],
    description: 'Tall portrait format for tablet and pin boards.',
    platformIcon: 'generic',
  },
  {
    id: '4:3',
  ...
  },
  {
    ...
    description: 'Vertical 35mm photo format.',
    platformIcon: 'generic',
  },
  {
    id: '5:4',
