...
try {
  ...
  const isolateVoiceItem = menu.getByRole('menuitem', { name: /^Isolate Voice/ })
  assert((await isolateVoiceItem.count()) === 1, 'Only single Isolate Voice item in main context menu')
  await isolateVoiceItem.hover()
